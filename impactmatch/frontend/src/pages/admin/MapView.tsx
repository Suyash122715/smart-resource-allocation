...
export default function AdminMapView() {
  ...
  const statCards = [
    ...
    { label: 'Active Volunteers',     value: totalVolunteers,  icon: Users,         color: 'text-brand-400',  bg: 'bg-brand-500/10' },
    { label: 'Open Needs',            value: totalOpenNeeds,   icon: Map,           color: 'text-accent-400', bg: 'bg-accent-500/10'},
  ];
    ...
    <div className="animate-fade-in">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-400 mt-1">Real-time need density across Bangalore</p>
        </div>
      </div>
